...
// rtc.createRoom('112233', 'room111', {}, function(err, roomInfo) {
// });

// rtc.getRoom('room111',  function(err, info) {
//    console.log(info);
// });

rtc.getRoomMember('room111', function (err, users) {
    console.log(users);
});

// rtc.deleteRoomMember('room111', '112233', function (err, res) {
//     console.log(res);
// });
