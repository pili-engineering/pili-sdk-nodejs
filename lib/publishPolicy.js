...
function PublishPolicy(params) {
  this.streamId = params.streamId;
  this.rtmpPublishHost = params.rtmpPublishHost;
  this.streamPublishKey = params.streamPublishKey;
  this.streamPublishSecurity = params.streamPublishSecurity;
  if (params.nonce) {
