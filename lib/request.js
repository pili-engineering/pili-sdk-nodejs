...
Request.prototype.get = function(mac, path, data, fn) {
  ...
  options.headers['Authorization'] = mac.generateAccessToken(options, null);
...
Request.prototype.post = function (mac, path, data, fn) {
  ...
  options.headers['Authorization'] = mac.generateAccessToken(options, dataString);
...
Request.prototype.delete = function (mac, path, fn) {
  var headers = {};
  var options = {
    host: this.host,
    path: '/' + config.API_VERSION + path,
