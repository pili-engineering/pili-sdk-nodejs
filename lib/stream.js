...
Stream.prototype.update = function(options, fn) {
  API.updateStream(this.id, options, fn);
}

Stream.prototype.delete = function(fn) {
  API.deleteStream(this.id, fn);
}

Stream.prototype.status = function(fn) {
  API.getStreamStatus(this.id, fn);
}

Stream.prototype.segments = function(options, fn) {
  API.getStreamSegments(this.id, options, fn);
}

Stream.prototype.toJSONString = function(prettyPrint) {
  if (prettyPrint) {
